...
import com.lk.robin.langlibrary.GuoXueDataHelper;
 ...
 */
@Route(path = ConstantsRouter.Home.HomeMainGuoXueCollectionFragment)
public class GuoXueCollectionFragment extends AppFragment {
    ...
    public GuoXueCollectionFragment() {
        // Required empty public constructor
    }

    @Override
    protected int getContentLayoutId() {
        return R.layout.fragment_guo_xue_collection;
    }
    ...
    protected void initData() {
        ...
        list.addAll(GuoXueDataHelper.getGuoXue());
