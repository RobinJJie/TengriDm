 ...
 */
public class ScheduleAdapter extends BaseRecyclerAdapter<ContentBean> implements BaseRecyclerHolder.OnAdapterItemClick {
    ...
    public BaseRecyclerHolder<ContentBean> getViewholder(ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(context)
                .inflate(R.layout.rm_item_programs_schedule, parent, false), this);
    }
    ...
    class ViewHolder extends BaseRecyclerHolder<ContentBean> {
        ...
        public void bindData(ContentBean bean) {
            ...
            if (isLive && this.getAdapterPosition() == 0) {
